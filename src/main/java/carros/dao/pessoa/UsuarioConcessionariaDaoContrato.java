...
public final class UsuarioConcessionariaDaoContrato {
	public final static String INSERIR_USUARIO_CONCESSIONARIA = "INSERT INTO usuario_concessionaria"
			+ " (concessionaria_idconcessionaria," + " usuario_idusuario, "
			+ "nivel_usuario_concessionaria_idnivel_usuario_concessionaria) " + "VALUES (?, ?, ?)";
	public static final String SELECT_USUARIO_CONCESSIONARIA_POR_ID_USUARIO = "SELECT * FROM usuario_concessionaria "
			...
			+ "JOIN telefone ON pessoa.telefone_idtelefone = telefone.idtelefone " + "INNER JOIN ( "
			+ "	SELECT idconcessionaria, fl_nota_avaliacao, int_numero_de_avaliacoes " + "    FROM concessionaria "
			+ "    ) AS concessionaria "
			+ "ON concessionaria.idconcessionaria = usuario_concessionaria.concessionaria_idconcessionaria "
			+ "JOIN imagem " + "ON imagem.idimagem = pessoa.imagem_idimagem " + "WHERE usuario_idusuario = ?";
