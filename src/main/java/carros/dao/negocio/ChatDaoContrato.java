...
public final class ChatDaoContrato {
	...
	public static final String BUSCAR_USUARIOS_CHAT = "SELECT * "
			+ "FROM chat_inclui_usuario_concessionaria "
			+ "JOIN usuario_concessionaria "
			+ "ON usuario_concessionaria.idusuario_concessionaria = "
